...
const Home = () => {
  ...
  const generatePDF = () => {
    ...
    doc.text('Liste des Factures', doc.internal.pageSize.width / 2, 15, { align: 'center' });
    ...
    for (let i = 1; i <= totalPages; i++) {
      ...
      doc.setTextColor(0, 0, 0);
      doc.text(`Generated by: ${window.location.href}`, doc.internal.pageSize.width / 2, 290, { align: 'center' });
    }
